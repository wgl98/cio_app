package com.cio_app.view.mine.demand.demandFinish;
...
public class DemandFinishFragment extends Fragment {
    private Context mContext;

    public static Fragment newInstance(){
        DemandFinishFragment fragment = new DemandFinishFragment();
        return fragment;
    }
