...
package com.lib_pickerview.style.citypickerview.widget.wheel;
...
import com.lib_pickerview.style.citypickerview.widget.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
     ...
     * 中间线的颜色
     */
    private String lineColorStr = "#3B70FF";
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(Color.parseColor("#3B70FF"));
